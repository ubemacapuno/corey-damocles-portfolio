...
<body class="${"svelte-1h1e6cy"}">
    ...
    default: () => {
      return `<div class="${"about-me-right svelte-1h1e6cy"}"><p class="${"svelte-1h1e6cy"}">I am a web developer based in Phoenix, AZ. I have a passion for learning new technologies and started my journey in coding and web development through self-teaching in January 2022. 
                </p>
                <p class="${"svelte-1h1e6cy"}">My skills include JavaScript, Node.js, Express.js, Svelte, React, MongoDB, Git, HTML, CSS, and SCSS. I am currently familiarizing myself with Typescript, the MERN stack, and other fun tech stacks!
                </p>
                <p class="${"svelte-1h1e6cy"}">Drop me a line if you\u2019d like to collaborate!
                </p></div>`;
    }
  })}</section></div>
    ...
    default: () => {
      return `<div class="${"projects-text svelte-1h1e6cy"}"><h3 class="${"svelte-1h1e6cy"}">Pok\xE9dex Lite</h3>
                ...
                <p class="${"svelte-1h1e6cy"}">HTML, CSS, JavaScript, Pok\xE9mon API by <a href="${"https://pokeapi.co/"}" class="${"svelte-1h1e6cy"}">Pok\xE9API.co</a>.</p>
    ...
    default: () => {
      return `<div class="${"projects-text svelte-1h1e6cy"}"><h3 class="${"svelte-1h1e6cy"}">Chromatic Climbers</h3>
                ...
                <p class="${"svelte-1h1e6cy"}">HTML , SCSS</p>
    ...
    default: () => {
      return `<div class="${"projects-image svelte-1h1e6cy"}"><a href="${"https://github.com/ubemacapuno/chromatic-climbers"}" class="${"svelte-1h1e6cy"}"><img class="${"project-img svelte-1h1e6cy"}"${(0, import_index_ae8bceff.a)("src", chromaticClimbers, 0)} alt="${"Chromatic Climbers project"}"></a></div>`;
    }
  })}</section></div>  
</body>`;
});
